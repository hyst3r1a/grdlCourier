...
@WebServlet("/dfix")
public class DriverFixServlet extends HttpServlet {
    final static Logger logger = LogManager.getLogger("com.zetcode");
       protected void doPost(HttpServletRequest request, HttpServletResponse response)
           ...
           if (Service.getXSSSecureParameter(request.getParameter("sessionId")).equals("106")) {


               try {
                  DriverService.driverFixCar(request);
