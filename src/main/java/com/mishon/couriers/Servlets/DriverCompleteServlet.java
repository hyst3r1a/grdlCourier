...
@WebServlet("/dcomplete")
public class DriverCompleteServlet extends HttpServlet {
    final static Logger logger = LogManager.getLogger("com.zetcode");
       protected void doPost(HttpServletRequest request, HttpServletResponse response)
           ...
           if (Service.getXSSSecureParameter(request.getParameter("sessionId")).equals("104")) {


               try {
                   DriverService.driverCompleteRequest(request);
